...
public class Run
{
    ...
    public void iniciar()
    {
        ...
        if(cantidadJugadores/3 == 0)crupier.setCantidadBarajas(1);
        else crupier.setCantidadBarajas(cantidadJugadores/3);
        ...
        for(int j = 0; j < 10 ; j++){
            ...
            if(iguales.size() == 0){
                ...
                System.out.print("Jugador " + (pm + 1) + ": ");
                
                System.out.print("\nCantidad de cartas: " + jugadores[pm].getSize()+"\n\n");
                for(int k = 0; k < jugadores[pm].getSize(); k++){
                    aux = jugadores[pm].getCarta(k);
                    esperar = aux.toString();
                    System.out.print( "|  "+ esperar + "  |");
                }
                System.out.print("\n\nCarta elegida: ");
                posicion = leer.nextInt();
                aux = jugadores[pm].getCarta(posicion - 1);
                jugadores[pm].removerCarta(posicion - 1);
                esperar = aux.toString();
                System.out.print("\n" + esperar + "\n\n");
                if(aux.getValor() > mayor){
                    mayor = aux.getValor();
        ...
        System.out.print("\n\nJuego terminado\n\n");
        int ganador = crupier.comprobarGanador(jugadores, cantidadJugadores);
        System.out.print("Gano el jugador " + (ganador + 1) + "\n\n");
